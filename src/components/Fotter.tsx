...
export default function Fotter (){
    return(
        <div className="flex flex-col items-center mt-7  mb-5">
            <div className="flex flex-col md:flex-row gap-2 w-full items-center justify-end px-10">
            ...
            <div className=" flex flex-col md:flex-row w-full pb-10 md:pb-0 justify-center md:justify-between mt-5 px-10 md:mt-8">
                ...
                <div className="flex gap-6 px-5 justify-center mt-3 md:mt-0">
